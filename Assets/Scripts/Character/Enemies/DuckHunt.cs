...
public class DuckHunt : Enemy
{
    ...
    {
        attacks = new Attack[4] { new DuckHuntGun(), new DuckHuntGun(), new Slap(), new Slap() };
    ...
    {
        string imagePath = Application.dataPath + "/Materials/EnemyAvatars/DuckHunt.png";
