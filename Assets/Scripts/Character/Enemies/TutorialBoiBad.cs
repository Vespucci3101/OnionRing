...
public class TutorialBoiBad : Enemy
{
    public TutorialBoiBad()
    {
        name = "Bad Tutorial Boi";
        health = 200;
        currentHealt = health;
    ...
    {
        attacks = new Attack[4] { new Slap(), new Slap(), new Slap(), new Slap() };
    ...
    {
        string imagePath = Application.dataPath + "/Materials/EnemyAvatars /character700Bad.png";
